...
import xyz.segurapass.backend.redis.entities.CredentialsWriteEntity;
import org.junit.jupiter.api.*;
import xyz.segurapass.api.credentials.*;
import xyz.segurapass.backend.exceptions.CredentialsException;
import xyz.segurapass.backend.model.authorization.UserDao;
import xyz.segurapass.backend.model.authorization.UserEntity;
import xyz.segurapass.backend.model.credentials.CredentialsDao;
import xyz.segurapass.backend.model.credentials.CredentialsEntity;
import xyz.segurapass.backend.service.CredentialsService;
